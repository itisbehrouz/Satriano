...
export function AddWholesaleProductModal({
  ...
  return (
    <div className="fixed inset-0 z-50 bg-black/60 backdrop-blur-xs flex items-center justify-center p-4 font-sans select-none overflow-y-auto">
      <div className="bg-white border border-[#EAECF0] rounded-md w-full max-w-[720px] text-[#111318] shadow-2xl relative p-6 space-y-6 my-8">
        {/* Header */}
        ...
        <form onSubmit={handleSubmit} className="space-y-6 text-xs max-h-[75vh] overflow-y-auto pr-1">
          {/* Section 1: Supplier & Category */}
          ...
          {/* Section 3: Product Images Uploader (PROMPT 3) */}
          <ProductImageUploader images={images} onChangeImages={setImages} />

          {/* Section 4: Pricing & Margin Calculation */}
