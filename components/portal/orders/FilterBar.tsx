...
export function FilterBar({
  ...
  return (
    <div className="bg-[#132A52] border border-[#2E5AAC] rounded-none p-4 font-sans select-none flex flex-col md:flex-row items-stretch md:items-center justify-between gap-4">
