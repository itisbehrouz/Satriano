...
## 📊 Detailed Color Ordering & Component Inspection Matrix (v2)
...
| Display | Colors in proforma PDF | `lib/pdfGenerator.ts:91` | YES (`colorName` rendered in proforma PDF line items) | Normal | Fixed (v2) |
