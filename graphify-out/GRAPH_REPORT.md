...
## Corpus Check
- 308 files · ~1,616,159 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 1640 nodes · 2261 edges · 181 communities (160 shown, 21 thin omitted)
- Extraction: 100% EXTRACTED · 0% INFERRED · 0% AMBIGUOUS · INFERRED: 2 edges (avg confidence: 0.65)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `19318534`
...
- ediAdapter.ts
- quickbooksSync.ts
- AUDIT-5-v2: Material, Components & Colourways Audit (Post-Fix Verification)
- fabric/[id]/route.ts
- proforma/route.ts
- locale/route.ts
- api/upload/route.ts
...
3. `Satriano Atelier — MVP Architecture & Roadmap (Consolidated, as of August 5, 2026 — Multi-Colourway Ordering, Homepage Redesign & Setup Fee Removal)` - 35 edges
4. `compilerOptions` - 16 edges
5. `SiteFooter()` - 15 edges
6. `formatCents()` - 14 edges
7. `AGENT 18 — COMPLETE UI/UX AUDIT & BUG FIX` - 13 edges
8. `SiteHeader()` - 12 edges
9. `useAdminAuth()` - 11 edges
10. `verifyCustomerToken()` - 11 edges
...
Cohesion: 0.16
Nodes (15): POST(), DELETE(), PATCH(), GET(), POST(), DELETE(), GET(), PATCH() (+7 more)
...
Cohesion: 0.07
Nodes (26): 10. Standing Tools (Skills), 11. General Lesson, 12. AI Agentic Skills & Autonomous Infrastructure (Added Aug 1), 13. System Health Check & Codebase Röntgen Snapshot (Aug 2, 2026), 14. Admin Navigation & Workspace Layout Refactoring (Aug 2, 2026), 15. Executive Admin KPI Dashboard & Client Portal Isolation (Aug 2, 2026), 16. B2B Customer Portal UI & Executive Dashboard Redesign (Aug 2, 2026), 17. B2B Customer Portal Account Settings & Support Hub (Aug 2, 2026) (+18 more)
...
Cohesion: 0.13
Nodes (14): 1. Database & Order Schema State Machine, 2. Configurator UI & Vector Logo Fix, 3. MOQ Validation Engine, 4. Automated Proforma Generation & Email Delivery, 5. Payment & Webhook Idempotency, AUDIT-1: Made-to-Order (M2O) Order Lifecycle Audit, 🚫 Blockers Status, 🔗 Cross-Stream Dependencies & Architecture Notes (+6 more)

### Community 22 - "Wholesalecheckoutclient Wholesalecheckoutclient() Wholesalecart"
Cohesion: 0.31
Nodes (10): WholesaleCheckoutClient(), SizeStockItem, WholesaleProductDetailClient(), WholesaleProductDetailData, addToWholesaleCart(), clearWholesaleCart(), getSampleDefaultCart(), getWholesaleCart() (+2 more)

### Community 23 - "Categories Page Categoriespage()"
Cohesion: 0.06
Nodes (33): 1.1 Scan all routes for UI pages, 1.2 Automated visual regression testing, 2.1 Find all hardcoded English strings, 2.2 Create hardcoded string inventory, 3.1 Navigation Component Audit, 3.2 Configurator Page Audit, 3.3 Wholesale Catalog Page Audit, 3.4 Admin Dashboard Audit (+25 more)
...
Cohesion: 0.19
Nodes (12): AvailableFabric, AvailableFabricColor, COMPONENT_LABELS, MaterialComponentSelector(), MaterialComponentSelectorProps, MaterialSelection, addToM2OCart(), getM2OCart() (+4 more)
...
Cohesion: 0.17
Nodes (11): 1. M2O Order Pricing Engine (`lib/pricing.ts`), 2. Price Snapshotting at Placement Time, 3. Setup Fee Elimination (Section 29.1 Compliance), AUDIT-4: Pricing Architecture & Commercial Rules Audit, 🚫 Blockers Status, 🔗 Cross-Stream Dependencies, 📊 Detailed Commercial Rules Inspection Matrix, P0 (Must Fix) (+3 more)
...
Cohesion: 0.29
Nodes (7): 32.1 Dedicated Project Port Allocation & Local Dev Server Hardening, 32.2 Full Codebase UI Audit & Bugfix Pass (`AGENT_18_UI_AUDIT_BUGFIX`), 32.3 Cloudflare Turnstile Bot Verification Infrastructure Purged, 32.4 Comprehensive Link Audit & Navigation Route Resolution (`AGENT_19_LINK_AUDIT`), 32.5 MANUFACTURING Nav Item & Deprecated `/configure` Route Removal, 32.6 Verification & Build Status, 32. Session Log: August 8, 2026
...
### Community 103 - "TurnstileWidget.tsx"
Cohesion: 0.08
...
Cohesion: 0.11
Nodes (18): 1. M2O Order Lifecycle & Proforma Delivery (AGENT-1), 2. Domain & Data Boundary Isolation (AGENT-2 & AGENT-6), 3. Wholesale Checkout & Stock Reservation (AGENT-3), 4. Pricing & Setup Fee Sanitation (AGENT-4), 5. Material Architecture & MOQ Engine (AGENT-5), 6. Authentication & System Hardening (AGENT-6), 📊 Confidence Levels Matrix, 🔍 Critical Path & Security Verification (+10 more)

### Community 108 - "InventoryTab.tsx"
Cohesion: 0.11
Nodes (18): 1. M2O Order Lifecycle & Proforma Delivery (AGENT-1 v2), 2. Domain & Data Boundary Isolation (AGENT-2 & AGENT-6 v2), 3. Wholesale Checkout & Stock Reservation (AGENT-3 v2), 4. Pricing & Setup Fee Sanitation (AGENT-4 v2), 5. Material Architecture & MOQ Engine (AGENT-5 v2), 6. Authentication & System Hardening (AGENT-6 v2), 📊 Confidence Levels Matrix, 🔍 Critical Path & Security Verification (+10 more)
...
Cohesion: 0.06
Nodes (10): JWT_SECRET, GET(), POST(), JWT_SECRET, releaseExpiredReservations(), reserveStockForOrder(), StockReservationStatus, globalForPrisma (+2 more)
...
Cohesion: 0.17
Nodes (11): 1. Schema Definitions & Model Isolation, 2. Privacy Isolation Architecture, 3. Automated Privacy Unit Testing, AUDIT-2: Wholesale Product Catalog & Taxonomy Audit, 🚫 Blockers Status, 🔗 Cross-Stream Dependencies, 🔒 Deep Dive: Supplier-Customer Data Boundary & Privacy Enclosure, 📊 Detailed Domain Isolation Inspection Matrix (+3 more)
...
Cohesion: 0.17
Nodes (11): 1. Cart Management & Storage, 2. Stock Reservation & Concurrency Atomicity, 3. Payment Webhook Idempotency, AUDIT-3: Wholesale Checkout, Inventory & Orders Audit, 🚫 Blockers Status, 📊 Detailed Critical Path Inspection Matrix, 🔍 Detailed Technical Analysis, 🔄 Domain Isolation & M2O Separation (+3 more)

### Community 163 - "wholesale/[productId]/page.tsx"
Cohesion: 0.17
Nodes (11): 1. Fabric & FabricColor Prisma Models, 2. Multi-Component Garment & Shoe Spec Model, 3. MOQ Validation Engine per Color, AUDIT-5: Material, Components & Colourways Audit, 🚫 Blockers Status, 🔗 Cross-Stream Dependencies, 📊 Detailed Color Ordering & Component Inspection Matrix, P0 (Must Fix) (+3 more)
...
Cohesion: 0.17
Nodes (11): 1. Constant-Time Access Key Comparison (`lib/adminAuth.ts`), 2. Algorithmic JWT Security & Pinning, 3. Global Command Palette ⌘K Security Guard, AUDIT-6: Security, Admin Operations & Data Boundaries Audit, 🚫 Blockers Status, 🔗 Cross-Stream Security Safeguards, 📊 Detailed Security & Data Boundaries Inspection Matrix, P0 (Must Fix) (+3 more)
...
### Community 171 - "AUDIT-1-v2: Made-to-Order (M2O) Order Lifecycle Audit (Post-Fix Verification)"
Cohesion: 0.13
Nodes (14): 1. Database & Order Schema State Machine, 2. Configurator UI & Vector Logo Fix (v2), 3. MOQ Validation Engine, 4. Automated Proforma Generation & Email Delivery (v2), 5. Payment & Webhook Idempotency, AUDIT-1-v2: Made-to-Order (M2O) Order Lifecycle Audit (Post-Fix Verification), 🚫 Blockers Status (v2), 🔗 Cross-Stream Dependencies & Architecture Notes (+6 more)

### Community 174 - "AUDIT-5-v2: Material, Components & Colourways Audit (Post-Fix Verification)"
Cohesion: 0.17
Nodes (11): 1. Fabric & FabricColor Prisma Models, 2. Multi-Component Garment & Shoe Spec Model, 3. MOQ Validation Engine per Color, AUDIT-5-v2: Material, Components & Colourways Audit (Post-Fix Verification), 🚫 Blockers Status (v2), 🔗 Cross-Stream Dependencies, 📊 Detailed Color Ordering & Component Inspection Matrix (v2), P0 (Must Fix) (+3 more)
...
- **Should `Wholesale Admin Page` be split into smaller, more focused modules?**
