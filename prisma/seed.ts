...
async function main() {
  ...
  const fitDefs = [
    ...
    },
    {
      code: "TAILORED",
      name: "Tailored Fit",
      description: "Refined architectural cut balancing chest comfort with a narrow tapered waist.",
      sortOrder: 4,
    },
    {
      code: "SKINNY",
      name: "Skinny Fit",
      description: "Ultra-slim form-fitting cut tight through the thigh, knee, and leg opening.",
      sortOrder: 5,
    },
    {
      code: "TAPERED",
      name: "Tapered Fit",
      description: "Roomy through seat and thigh, narrowing sharply down towards the ankle.",
      sortOrder: 6,
    },
    {
      code: "MODERN",
      name: "Modern Fit",
      description: "Slightly trimmer than regular fit without restricting armhole or shoulder mobility.",
      sortOrder: 7,
    },
    {
      code: "OVERSIZED",
      name: "Oversized",
      description: "Contemporary streetwear silhouette featuring dropped shoulders and boxy body.",
      sortOrder: 8,
    },
  ];
    ...
    },
    {
      ...
      subcategories: [
        ...
        },
        {
          name: "Jeans",
          slug: "jeans",
          description: "Selvedge & Straight Leg Denim Jeans.",
          imageUrl: "/images/catalog/bottoms.png",
          systems: ["Waist_EU", "Waist_US"],
          products: [
            {
      ...
      subcategories: [
        ...
        },
        {
          ...
          products: [
            ...
            {
              name: "Cotton Hopsack Casual Blazer",
              slug: "hopsack-casual-blazer",
    ...
    },
    {
      ...
      subcategories: [
        ...
        },
        {
          name: "Tuxedos",
          slug: "tuxedos",
          description: "Eveningwear Satin Lapel Tuxedos & Dinner Jackets.",
        ...
        },
        {
          ...
          products: [
            ...
            {
              name: "Structured Wool Flannel Blazer",
              slug: "wool-flannel-blazer",
        ...
        },
        {
          name: "Waistcoats",
          slug: "waistcoats",
          description: "Double-Breasted Suit Vests & Tailored Waistcoats.",
          imageUrl: "/images/catalog/formal_wear.png",
          systems: ["Chest_EU", "Chest_US"],
          products: [
            {
              name: "Double-Breasted Suit Vest",
              slug: "double-breasted-waistcoat",
      ...
      subcategories: [
        ...
        },
        {
          ...
          products: [
            ...
            {
              name: "Ergonomic Compression Leggings",
      ...
      subcategories: [
        ...
        },
        {
          ...
          products: [
            ...
            {
              name: "Seamless Micro-Modal Trunks",
              slug: "seamless-trunks",
        ...
        },
        {
          ...
          products: [
            ...
            {
              name: "Fine Merino Wool Dress Socks",
              slug: "merino-dress-socks",
  ...
  for (const catData of catalog) {
    ...
    for (const subDef of catData.subcategories) {
      ...
      for (const prodDef of subDef.products) {
        ...
        // Link allowed fits (clear previous if updating)
        await prisma.productFit.deleteMany({
          where: { productId: product.id },
        });

        if (prodDef.fits && prodDef.fits.length > 0) {
          for (const fitCode of prodDef.fits) {
            const fitId = createdFits[fitCode];
            if (fitId) {
              await prisma.productFit.create({
                data: {
